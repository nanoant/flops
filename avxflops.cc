...
double test_dp_mac_AVX(double x,double y,size_t iterations){
	...
	r1 = _mm256_set1_pd( y);
	r2 = _mm256_set1_pd( y);
	r3 = _mm256_set1_pd( 1.0);
	r4 = _mm256_set1_pd(-1.0);
	r5 = _mm256_set1_pd( 1.0);
	r6 = _mm256_set1_pd(-1.0);
	r7 = _mm256_set1_pd( 1.0);
	r8 = _mm256_set1_pd(-1.0);
	r9 = _mm256_set1_pd( 1.0);
	rA = _mm256_set1_pd(-1.0);
	rB = _mm256_set1_pd( 1.0);
	rC = _mm256_set1_pd(-x);
	rD = _mm256_set1_pd( x);
	rE = _mm256_set1_pd(-y);
	rF = _mm256_set1_pd( y);
